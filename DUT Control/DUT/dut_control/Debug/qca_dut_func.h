...
DLL_QMSL_AEROFLEX void _stdcall  XTALCal(int channel, int txChain0, int iXtalTargetPPM, unsigned int iXtalTolerancePPM, unsigned int dXtalCalSaveOption, unsigned int  XtalCapDelta, int numMeasAvg, char Visa_address[100], int Port);
...
/// </summary>
DLL_QMSL_AEROFLEX long	_stdcall Power_calibration(int type, char Visa_address[100], int Port, double refLevel);
// ======================================================================================================
/// <summary>
...
DLL_QMSL_AEROFLEX long _stdcall StopRxWithReport();
DLL_QMSL_AEROFLEX int _stdcall RxGainCal(unsigned int radioId, unsigned int chainToCalibrate, char Visa_address[100], char WaveformNameWithType[100], int Port, double SG_level, int SG_Freq, int RxPackets, int Rx_rate);
